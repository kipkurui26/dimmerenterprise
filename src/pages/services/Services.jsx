  ...
  const servicesList = [
    {
      ...
      miniBannerContent: "Comprehensive hydrogeological surveys to identify groundwater resources and ensure optimal borehole placement.",
      imageAlt: "Hydrogeological Survey Dimmer Enterprises LTD Banner",
    },
    {
      id: 2,
      breadcrumbTitle: "Borehole Drilling Services",
      miniBannerContent: "Professional borehole drilling services for reliable water access in residential, commercial, and industrial applications.",
      imageAlt: "Borehole Drilling Dimmer Enterprises LTD Banner",
    },
    {
      id: 3,
      breadcrumbTitle: "Borehole Camera Inspection Services",
      miniBannerContent: "Advanced camera inspections to assess borehole conditions and ensure optimal performance and longevity.",
      imageAlt: "Borehole Camera Inspection Dimmer Enterprises LTD Banner",
    },
    {
      id: 4,
      breadcrumbTitle: "Borehole Test Pumping Services",
      miniBannerContent: "Thorough test pumping services to evaluate groundwater yield and quality, ensuring sustainable water management.",
      imageAlt: "Borehole Test Pumping Dimmer Enterprises LTD Banner",
    },
    {
      id: 5,
      breadcrumbTitle: "Pump and Solar Installation Services",
      miniBannerContent: "Efficient pump and solar installations for sustainable and cost-effective water supply solutions.",
    ...
    },
    {
      ...
      miniBannerContent: "Robust tank and tower construction services for secure and reliable water storage solutions.",
      imageAlt: "Elevated Tank Tower Construction Dimmer Enterprises LTD Banner",
    },
  ];
